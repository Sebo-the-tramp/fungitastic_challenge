...
MODEL_TRAIN = Path(f"facebook/dinov3-vit7b16-pretrain-lvd1689m/bfloat16_normal_{IMAGE_SIZE}/train")
MODEL_VAL = Path(f"facebook/dinov3-vit7b16-pretrain-lvd1689m/bfloat16_normal_{IMAGE_SIZE}/val")
MODEL_TEST = Path(f"facebook/dinov3-vit7b16-pretrain-lvd1689m/bfloat16_normal_{IMAGE_SIZE}/test")
