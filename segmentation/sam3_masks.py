...
if DATASET == "fungi_tastic":
    from dataset.fungi import FungiTastic as DatasetFungiTastic
elif DATASET == "mask_fungi_tastic":
    from dataset.mask_fungi import MaskFungiTastic as DatasetFungiTastic
...
def build_label_maps(dataset: DatasetFungiTastic) -> tuple[dict[int, int], dict[int, str], list[str]]:
...
def build_prompt_config(dataset: DatasetFungiTastic) -> tuple[dict[int, int], dict[int, str], list[str]]:
